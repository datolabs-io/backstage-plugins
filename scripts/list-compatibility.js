...
async function main(args) {
  ...
  for (const workspace of workspaces) {
    const workspaceReport = {
      workspace: `[${workspace}](https://github.com/datolabs-io/backstage-plugins/tree/main/workspaces/${workspace})`,
      'version-compatibility': `![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%datolabs-io%2Fbackstage-plugins%2Fmain%2Fworkspaces%2F${workspace}%2Fbackstage.json&query=%24.version&label=Backstage%20Version)`,
    };
