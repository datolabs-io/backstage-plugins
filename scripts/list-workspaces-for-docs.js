...
async function main(args) {
  ...
  for (const workspace of workspaces) {
    ...
    const filteredOwners = owners.filter(
      o => o !== '@datolabs-io/backstage-plugins-maintainers',
    );
    ...
    const workspaceOwners =
      filteredOwners.length === 0
        ? '[datolabs-io/backstage-plugins-maintainers](https://github.com/orgs/datolabs-io/teams/backstage-plugins-maintainers)'
        : filteredOwners.join(', ');
